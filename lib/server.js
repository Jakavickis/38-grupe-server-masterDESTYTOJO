...
server.httpServer = http.createServer((req, res) => {
    ...
    //cliento siuntimo uzklausa pdf video ir t.t. 
    ...
    //vartotojo uzklausos pabaiga, t.y. kliento siuntimo uzklausa END.
    req.on('end', async () => {
        buffer += decoder.end();
        ...
        // kai klientas noretu apsikeisti duomenimis
        if (isAPI) {
...
export { server };
        ...
        // // jeigu trimmedPath egzistuojas ? mes issikvieciame funckija : priesingu atveju 404 funkcija
        ...
        // // ar vienas is serverio path'u yra trimmedPath raktazodziu in server routes
